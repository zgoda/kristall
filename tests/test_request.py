...
class TestRequest:
    ...
    def test_create_custom_decoder(self, custom_decoder):
    ...
    def test_get_data_entity_too_large(self):
    ...
    def test_get_data_ok_form(self):
        fld_name = 'field'
        fld_value = 'value'
        builder = EnvironBuilder(
    ...
    def test_get_data_ok_json(self):
        data = {
            'field': 'value'
        }
        builder = EnvironBuilder(
    ...
    def test_get_json_custom_decoder(self, custom_decoder):
        data = {
            'field': 'value'
        }
        builder = EnvironBuilder(
